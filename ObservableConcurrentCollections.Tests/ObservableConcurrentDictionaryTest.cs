...
public class ReadOnlyDictionary : ObservableConcurrentDictionary<string, string>
{
...
public class ConcurrencyTest
{
    ...
    {
        var raiseCount1 = 0;
        var dict = new ObservableConcurrentDictionary<string, string>();
...
public class IndexerTest
{
    ...
    public void Normal()
    {
        ...
        var dict = new ObservableConcurrentDictionary<string, string>(new List<KeyValuePair<string, string>>
        {
...
public class ConstructorTest
{
    ...
    {
        var dict = new ObservableConcurrentDictionary<string, string>(new EqualityComparer());
    ...
    {
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        Assert.Throws<ArgumentNullException>(() => new ObservableConcurrentDictionary<int, int>((IEnumerable<KeyValuePair<int, int>>?)null));
        Assert.Throws<ArgumentNullException>(() => new ObservableConcurrentDictionary<int, int>((IEqualityComparer<int>?)null));
        Assert.Throws<ArgumentNullException>(() => new ObservableConcurrentDictionary<int, int>(null, null));
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    }
}
...
public class GetEnumeratorTest
{
    ...
    public void ForLoop()
    {
        ...
        var enumerator = (ObservableConcurrentDictionary<string, string>.DictionaryEnumerator)dict.GetEnumerator();
