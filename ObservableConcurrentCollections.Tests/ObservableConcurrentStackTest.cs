...
public class ReadOnlyStack : ObservableConcurrentStack<int>
{
...
public class IndexerTest
{
    ...
    public void Normal()
    {
        ...
        var col = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
...
public class IsEmptyTest
{
    ...
    public void Normal()
    {
        var col1 = new ObservableConcurrentStack<int>();
        var col2 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3, 4 });
...
public class ConstructorTest
{
    ...
    {
        var col = new ObservableConcurrentStack<int>();
    ...
    {
        var col = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3, 4 });
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
        Assert.Throws<ArgumentNullException>(() => new ObservableConcurrentStack<int>(null));
...
public class ClearTest
{
    ...
    {
        var raiseCol = new List<NotifyCollectionChangedEventArgs>();
        var col = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3, 4, 5, 6 });
...
public class PeekTest
{
    ...
    public void Normal()
    {
        var col1 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col2 = new ObservableConcurrentStack<int>(new int[] { 3, 2, 1 });
...
public class PopTest
{
    ...
    public void Throws()
    {
        ...
        var col2 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
...
public class PushRangeTest
{
    ...
    public void Normal()
    {
        ...
        var col1 = new ObservableConcurrentStack<int>();
        var col2 = new ObservableConcurrentStack<int>();
        var col3 = new ObservableConcurrentStack<int>();
        var col4 = new ObservableConcurrentStack<int>();
        var col5 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col6 = new ObservableConcurrentStack<int>();
...
public class TryPopRangeTest
{
    ...
    public void Normal()
    {
        ...
        var col1 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col2 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col3 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col4 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col5 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
        var col6 = new ObservableConcurrentStack<int>(new int[] { 1, 2, 3 });
